...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Length(
        ...
        maxMessage: 'Le mot de passe contenir au maximum {{ limit }} caractères.',
    )]
    #[Assert\Regex(
        pattern: '/^(?=.*[a-zà-ÿ])(?=.*[A-ZÀ-Ỳ])(?=.*[0-9])(?=.*[^a-zà-ÿA-ZÀ-Ỳ0-9]).{11,255}$/',
        match: true,
        message: "Le mot de passe doit être composé d'au moins une lettre majuscule, d'une minuscule, d'un chiffre et d'un caractère spécial.",
    )]
    #[ORM\Column]
